...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (modal) {
        ...
        // Verifica se o .modal-content existe antes de adicionar o listener
    ...
    const miniCalendar = new FullCalendar.Calendar(miniCalendarEl, {
        ...
        dayMaxEvents: true,
        dateClick: function(info) {
            // Quando clica numa data no mini-calendário, leva para essa data no calendário principal
            calendar.gotoDate(info.date);
            calendar.changeView('timeGridDay'); // Muda para visualização de dia
        },
        events: calendar.getEventSources()[0] // Compartilha a mesma fonte de eventos
    });
